...
class EtcdService {
  ...
  _timeoutHint(profile) {
    ...
    return `${base}. Check that the endpoint really is etcd's client port (2379) ` +
      'and that the CA, certificate, and key belong to this cluster.';
  }
