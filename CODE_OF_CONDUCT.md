...
requests, discussions, and any other project-affiliated forum), and also
...
[GitHub security advisory](https://github.com/mchenetz/etcdee/security/advisories/new)
or by contacting the maintainer listed in [MAINTAINERS.md](MAINTAINERS.md)
...
This is the same Code of Conduct template adopted by CNCF projects; see the
[CNCF Community Code of Conduct](https://github.com/cncf/foundation/blob/main/code-of-conduct.md)
for the org-wide version.
